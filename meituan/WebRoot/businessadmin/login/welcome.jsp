...
<link href="${pageContext.request.contextPath}/businessadmin/css/Style.css" type="text/css" rel="stylesheet" />
<style type="text/css">
<!--
body {
...
<form name="Form1" method="post" action="name.aspx" id="Form1">
	...
	<table width="100%" border="0" height="88" border="1" background="${pageContext.request.contextPath}/businessadmin/images/back1.JPG">
		<tr>
