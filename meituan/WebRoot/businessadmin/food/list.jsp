...
<script language="javascript"
	src="${pageContext.request.contextPath}/businessadmin/js/public.js"></script>
<script type="text/javascript">
	function addProduct() {
		window.location.href = "${pageContext.request.contextPath}/businessadmin/food/add.jsp";
	}
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath }/FindFoodByMyId?id=${b.fid }">
											<img
											src="${pageContext.request.contextPath}/businessadmin/images/i_edit.gif"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										onclick="javascript:delbook('${b.fid }','${b.foodname }')">
											<img
											src="${pageContext.request.contextPath}/businessadmin/images/i_del.gif"
