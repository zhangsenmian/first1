...
<html>
	<head>
		...
		<title></title>
		<link href="${pageContext.request.contextPath}/businessadmin/css/Style.css" rel="stylesheet" type="text/css">
		<style type="text/css">
<!--
.style1 {
	color: #FF0000;
					...
					<table width="453" height="220" border="0" cellpadding="0"
						...
						<tr>
							<td height="220" align="center" valign="middle"
								background="${pageContext.request.contextPath}/businessadmin/images/loginbg.gif">
								<p class="style1">
