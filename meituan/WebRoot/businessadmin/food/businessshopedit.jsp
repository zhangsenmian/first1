...
<script language="javascript"
	src="${pageContext.request.contextPath}/businessadmin/js/check.js"></script>
...
<body  onload="setProductCategory('${shop.category}')">
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath }/EditShopBusinessServlet" method="post"
...
<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<TR>
				<td align="center" colSpan="4" class="sep1"><img
					src="${pageContext.request.contextPath}/businessadmin/images/shim.gif">
				</td>
			</TR>
