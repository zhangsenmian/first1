...
/**
 * Servlet implementation class FindFoodBusByIdServlet
 */
public class FindFoodBusByIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindFoodBusByIdServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(list!=null){
			...
			request.getRequestDispatcher("/businessadmin/food/list.jsp").forward(request, response);
		}
	}
