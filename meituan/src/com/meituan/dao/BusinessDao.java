...
public class BusinessDao {
	...
	public Business checkName(Business bs) throws Exception {
		QueryRunner qr=new QueryRunner(C3P0Util.getDataSource());
		return qr.query("select * from business where business_name =? and business_password = ?",new BeanHandler<Business>(Business.class),bs.getBusiness_name(),bs.getBusiness_password());
